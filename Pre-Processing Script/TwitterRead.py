...
list_stress_words = ["heart", "control", "depression", "disease", "study", "studies", "life", "stressor", "body",
                     "stress",
                     "anxiety", "health", "feel", "pain", "social", "stressors", "pressure", "work", "risk",
                     "stressful", "busy",
                     "depressed", "nervous", "university", "cancer", "marry", "wedding", "bride", "income", "salary",
                     "rent",
                     "hospital", "sick", "school", "holiday", "finals", "born", "baby", "life", "fired", "job", "lose",
                     "cold",
                     "war", "quarrel", "argue", "question", "blame", "afraid", "baby", "pregnant", "mother-to-be",
                     "revise", "habits", "smoke", "drink", "pass", "away", "RIP", "divorce", "ex-wife", "cry",
